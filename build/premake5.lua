...
Projects = {
	...
	},
	{
		...
		Files = {
			"../include/GameLibShared/**.hpp",
			"../include/GameLibShared/**.inl",
			"../src/GameLibShared/**.hpp",
			"../src/GameLibShared/**.inl",
			"../src/GameLibShared/**.cpp"
		},
		Frameworks = {"Nazara"},
		LinkStatic = {},
	...
	},
	{
		...
		Frameworks = {"Nazara"},
		LinkStatic = {},
		LinkStaticDebug = {"GameLibShared-d", "Lua-d"},
		LinkStaticRelease = {"GameLibShared", "Lua"},
	...
	},
	{
		...
		LinkStatic = {},
		LinkStaticDebug = {"GameLibShared-d"},
		LinkStaticRelease = {"GameLibShared"},
		Libs = os.istarget("windows") and {} or {"pthread"},
