...
#ifndef BURGWAR_SHARED_COMPONENTS_ANIMATIONCOMPONENT_HPP
#define BURGWAR_SHARED_COMPONENTS_ANIMATIONCOMPONENT_HPP
...
#include <GameLibShared/Components/AnimationComponent.inl>
